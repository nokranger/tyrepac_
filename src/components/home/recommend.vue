<template>
    ...
    <div>
      ...
      <div>
        <b-container>
          ...
          <br>
          <b-row>
            <b-col cols="12" sm="6" md="4" lg="3" xl="2" v-for="(item, index) in promotions" :key="index" style="margin-top: 25px;">
              <div style="border-radius: 5px;border: thin solid #E0E0E0;text-align: left;height: 470px;width: 100%;">
                ...
                <div style="color: #005099;display: inline-block;"> ต่อเส้น</div>
  ...
  <div v-else-if="languages === 'EN'">
    <br>
    <div>
      <div style="font-weight: bold;font-size: 25px;">Tires of Recommend and Promotion </div>
      <div>Great deals from tire brands</div>
      <div>
        <b-container>
          <b-container>
          <br>
            ...
            <b-col cols="12" sm="6" md="4" lg="3" xl="2" v-for="(item, index) in promotions" :key="index" style="margin-top: 25px;">
              <div style="border-radius: 5px;border: thin solid #E0E0E0;text-align: left;height: 470px;width: 100%;">
                ...
                <div style="margin-bottom: 4px;margin-left: 20px;margin-right: 20px;">
                  ...
                  <div>
                    <i class="fa-solid fa-plus" style="cursor: pointer;" @click="compare(item)"></i><a style="cursor: pointer;margin-left: 5px;color: #005099;font-weight: bold;"  @click="showcompare()" v-b-modal.modal-1>Tire Details</a>
                  </div>
                </div>
              </div>
            </b-col>

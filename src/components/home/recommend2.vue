            ...
            <b-col cols="6" sm="6" md="6" lg="3" xl="3" v-for="(item, index) in promotions" :key="index" style="margin-top: 5px;">
              <div style="border-radius: 5px;border: thin solid #E0E0E0;text-align: left;width: 100%;height: 410px;">
                ...
                <div style="\margin-bottom: 4px;margin-left: 20px;margin-right: 20px;">
                  ...
                  <div>
                    <i class="fa-solid fa-plus" style="cursor: pointer;" @click="compare(item)"></i><a style="cursor: pointer;margin-left: 5px;color: #005099;"  @click="showcompare()" v-b-modal.modal-1>ข้อมุลสินค้า</a>
                  </div>
                </div>
              </div>
            </b-col>
